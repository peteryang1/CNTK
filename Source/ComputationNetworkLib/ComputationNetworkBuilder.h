...
public:
    ...
    shared_ptr<ComputationNode<InputValueType>> TypedCreateInputNode(const std::wstring& inputName, const TensorShape& sampleLayout, const wstring& dynamicAxisName);
    ...
    template <class InputValueType>
    shared_ptr<ComputationNode<InputValueType>> TypedCreateSparseInputNode(const std::wstring& inputName, const TensorShape& sampleLayout, const wstring& dynamicAxisName);
